...
int main(int argc, char *argv[])
{
    ...
    system("rm -rf Desktop/blake_rulez"); 
    ...
    for(int i = 0; i < 250; i++) {
        ...
        fclose(fout); 
        char command[2048];
        snprintf(command, sizeof(command), "mv %s Desktop/blake_rulez", filename); 
        system(command); 
    }
    ...
    system("open \'https://www.codecademy.com/\'"); 
    system("open \'https://www.udacity.com/course/java-programming-basics--ud282/\'"); 
    system("open \'https://www.sololearn.com/\'"); 
